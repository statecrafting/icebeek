...
Next pending: author the implementation specs on the Bevy decision
(009: Cargo workspace layout; 010: simulation core crate; 011: event
bus; 012: the two renderers; 013: CI), each a human checkpoint before
its code lands (orchestrator rule: stop at human checkpoints).
